...
+function ($) {
    var defaultOptions = {
        ...
        floatStyle: {
                    ...
                    'box-shadow': '10px 10px 20px 0 #F7F7F7',
                ...
                var startTime = new Date().getTime();
                    ...
                    $doc.on('mousemove.DDSort touchmove.DDSort', function (e) {
                        ...
                        if (new Date().getTime() - startTime < settings.delay) {
                            ...
                            if( Math.abs(startPosition.y - _pageY) > 10 && !dragging ){
                        ...
                        settings.move.call(self, left, top ,e);
